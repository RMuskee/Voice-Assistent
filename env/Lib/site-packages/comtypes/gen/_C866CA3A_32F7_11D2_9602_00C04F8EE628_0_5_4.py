...
__all__ = [
    'SGDSActiveUserDelimited', 'SVSFNLPSpeakPunc',
    'DISPID_SPRuleChildren', 'ISpeechPhraseElement', 'SpCustomStream',
    'SPSSuppressWord', 'SPSERIALIZEDPHRASE', 'SGRSTTEpsilon',
    'ISpeechLexiconWords', 'SVSFDefault', 'SpWaveFormatEx',
    'SpUnCompressedLexicon', 'SpeechDictationTopicSpelling',
    'SAFT11kHz8BitStereo', 'SP_VISEME_9', 'SPWT_LEXICAL',
    'DISPID_SLPPartOfSpeech', 'SpeechAddRemoveWord',
    'SPEI_PROPERTY_STRING_CHANGE', 'eLEXTYPE_PRIVATE7', 'SFTSREngine',
    'DISPID_SVSInputWordLength', 'SpeechCategoryRecognizers',
    'SP_VISEME_18', 'SVP_20', 'DISPID_SRCRetainedAudio',
    'SSFMOpenForRead', 'SpeechPartOfSpeech', 'DISPID_SRCRecognizer',
    'DISPID_SDKGetBinaryValue', 'Speech_StreamPos_RealTime',
    'SRTExtendableParse', 'SpeechVoiceEvents', 'SLODynamic',
    'SPFM_CREATE', 'DISPID_SOTGetStorageFileName',
    'SAFTADPCM_44kHzStereo', 'SPPHRASERULE', 'DISPID_SGRs_NewEnum',
    'SPFM_NUM_MODES', 'DISPID_SGRSTWeight',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SRCEEndStream',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SABIBufferSize',
    'SpeechAudioFormatGUIDText', 'DISPID_SPRuleConfidence',
    'SAFT44kHz16BitMono', 'ISpPhraseAlt', 'SPEI_RESERVED6',
    'DISPID_SpeechRecoResultTimes', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPEDisplayAttributes', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRCEFalseRecognition', 'DISPID_SRIsShared', 'SGSDisabled',
    'SVEPhoneme', 'ISpRecognizer3', 'DISPID_SPIEnginePrivateData',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPIAudioSizeBytes', 'SPAUDIOOPTIONS',
    'SAFTADPCM_22kHzMono', 'DISPID_SRGIsPronounceable',
    'SPEI_RESERVED3', 'DISPID_SOTCategory', 'SWTDeleted',
    'DISPID_SGRSTRule', 'DISPID_SOTCSetId',
    'ISpeechLexiconPronunciations', 'SPWORDTYPE',
    'DISPID_SGRAddResource', 'SpShortcut', 'DISPID_SGRsAdd',
    'tagSTATSTG', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SAFT32kHz16BitMono', 'DISPID_SVWaitUntilDone',
    'SAFT16kHz16BitStereo', 'DISPID_SpeechAudioFormat',
    'SPBINARYGRAMMAR', 'SREPropertyStringChange',
    'DISPID_SGRAddState', 'DISPID_SVVoice', 'SPSModifier',
    'SDA_One_Trailing_Space', 'SpeechPropertyComplexResponseSpeed',
    'ISpRecoGrammar', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SpeechPropertyLowConfidenceThreshold', 'SPSHORTCUTTYPE',
    'ISpeechPhraseElements', 'SPAS_STOP', 'SRCS_Disabled',
    'SPLO_DYNAMIC', 'DISPID_SRRSetTextFeedback', 'DISPID_SLPPhoneIds',
    'ISpeechRecoResultDispatch', 'DISPID_SPCPhoneToId',
    'SWPUnknownWordPronounceable', 'DISPID_SVSpeak',
    'DISPID_SPEs_NewEnum', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPRsItem',
    'SPSNotOverriden', 'SAFT48kHz8BitMono', 'DISPID_SRCVoice',
    'ISpeechRecoContext', 'SECLowConfidence',
    'SpeechEmulationCompareFlags', 'DISPID_SAFSetWaveFormatEx',
    'SPDKL_DefaultLocation', 'SpFileStream', 'SpeechTokenContext',
    'DISPID_SPAsItem', 'DISPID_SREmulateRecognition',
    'DISPID_SpeechDataKey', 'DISPID_SGRSTNextState',
    'DISPID_SRRTStreamTime', 'DISPID_SGRSTPropertyValue',
    'SPCS_DISABLED', 'SWPUnknownWordUnpronounceable',
    'SpPhoneticAlphabetConverter', 'SECFIgnoreKanaType',
    'ISpeechFileStream', 'SVEStartInputStream', 'SPWF_INPUT',
    'DISPID_SPRuleNumberOfElements', 'SPSMF_SAPI_PROPERTIES', 'SVP_7',
    'SAFTText', 'Speech_Max_Word_Length', 'Speech_StreamPos_Asap',
    'DISPID_SRIsUISupported', 'SpeechVoicePriority',
    'DISPID_SPIStartTime', 'DISPID_SpeechPhraseRules', 'eLEXTYPE_APP',
    'SVF_Stressed', 'DISPID_SLPsCount', 'DISPID_SRCSetAdaptationData',
    'DISPIDSPRG', 'DISPID_SPAPhraseInfo', 'ISpeechObjectTokens',
    'SpeechPropertyNormalConfidenceThreshold', 'ISpProperties',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SDKEnumKeys',
    'eLEXTYPE_RESERVED6', 'SAFT22kHz8BitMono',
    'DISPID_SRCEAdaptation', 'DISPID_SBSRead', 'SPINTERFERENCE',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SpeechGrammarRules',
    'DISPID_SVResume', 'DISPID_SAFGuid', 'SAFTADPCM_8kHzMono',
    'SVP_0', 'DISPID_SVEViseme', 'ISpeechPhraseRules',
    'eLEXTYPE_PRIVATE4', 'DISPID_SRSAudioStatus', 'SAFT24kHz8BitMono',
    'DISPIDSPTSI_ActiveOffset', 'SPCT_SLEEP', 'SPRS_ACTIVE',
    'SP_VISEME_14', 'DISPID_SVSCurrentStreamNumber', 'DISPID_SVRate',
    'DISPID_SVEPhoneme', 'DISPID_SPRuleName',
    'DISPID_SPEAudioSizeTime', 'DISPID_SLWsCount',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SOTs_NewEnum',
    'ISpRecoCategory', 'SPEI_START_SR_STREAM', 'SPWT_PRONUNCIATION',
    'SITooLoud', 'DISPID_SpeechMMSysAudio', 'SVEBookmark',
    'DISPID_SPEAudioSizeBytes', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SRSSupportedLanguages', 'SLTUser', 'SpeechAudioVolume',
    'SGDSInactive', 'SPPS_LMA', 'SPEI_PHONEME',
    'SDA_Consume_Leading_Spaces', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRRTTickCount', 'SREPrivate', 'DISPID_SGRSTPropertyId',
    'DISPID_SRRAlternates', '_RemotableHandle', 'DISPID_SLPsItem',
    'DISPID_SASCurrentDevicePosition', 'SECFIgnoreWidth',
    'DISPID_SGRSRule', 'SGDSActive', 'SASStop', 'SINoSignal',
    'SPPS_Interjection', 'SpeechAudioProperties',
    'SpeechTokenKeyAttributes', 'DISPID_SRCESoundStart',
    'SPEI_RESERVED2', 'SVP_2', 'SP_VISEME_8',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRDisplayUI', 'SAFTADPCM_11kHzStereo', 'SRADynamic',
    'SAFT24kHz16BitMono', 'ISpeechPhraseProperties',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPEVENTENUM', 'SPSLMA',
    'SPPS_Verb', 'SpeechVisemeFeature', 'Speech_Default_Weight',
    'DISPID_SAFType', 'ISpAudio', 'ISpeechRecoResultTimes',
    'SASPause', 'DISPID_SOTId', 'DISPID_SPISaveToMemory',
    'SVSFParseSapi', 'SPEI_PROPERTY_NUM_CHANGE', 'eWORDTYPE_ADDED',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRRGetXMLResult',
    'SPPS_Noun', 'DISPID_SRRTOffsetFromStart', 'eLEXTYPE_PRIVATE15',
    'SRADefaultToActive', 'DISPID_SPPNumberOfElements',
    'STCInprocServer', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SMSALineId', 'SPAUDIOBUFFERINFO', 'ISpeechGrammarRule',
    'SECFEmulateResult', 'ISpGrammarBuilder',
    'DISPID_SpeechPhraseProperties', 'DISPIDSPTSI_SelectionLength',
    'SPRULE', 'SpVoice', 'SPEI_REQUEST_UI', 'ISpPhoneConverter',
    'SSFMCreate', 'SPRECOGNIZERSTATUS', 'eLEXTYPE_PRIVATE19',
    'ISpStreamFormat', 'DISPID_SVAudioOutputStream',
    'SAFTGSM610_22kHzMono', 'DISPIDSPTSI',
    'ISpeechGrammarRuleStateTransition', 'SPRST_INACTIVE',
    'SPEI_SR_PRIVATE', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRCRequestedUIType', 'SREAllEvents',
    'DISPID_SPRuleFirstElement', 'SpeechTokenValueCLSID',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SBSSeek',
    'DISPID_SOTGetDescription', 'SPSHT_OTHER',
    'ISpStreamFormatConverter', 'DISPID_SRSetPropertyString',
    'SRAORetainAudio', 'SVSFlagsAsync', 'eLEXTYPE_RESERVED10',
    'DISPID_SPIProperties', 'SECFNoSpecialChars', 'SGDisplay',
    'DISPID_SRRTLength', 'SVP_4', 'SpeechTokenKeyUI',
    'ISpeechPhraseAlternate', 'SPCT_COMMAND',
    'ISpeechGrammarRuleStateTransitions', 'SPEI_END_SR_STREAM',
    'DISPID_SPERequiredConfidence', 'DISPID_SLWWord',
    'DISPID_SRCEPhraseStart', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPAStartElementInResult',
    'SECHighConfidence', 'ISpeechVoice', 'DISPID_SRGDictationUnload',
    'DISPID_SPEPronunciation', 'SpeechLoadOption',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPRulesItem',
    'SpeechWordPronounceable', 'DISPID_SpeechPhraseBuilder', 'SDTAll',
    'DISPID_SGRSTPropertyName', 'SP_VISEME_0',
    'DISPID_SPELexicalForm', 'SpCompressedLexicon', 'SITooSlow',
    'SpeechCategoryAudioIn', 'SPEI_TTS_BOOKMARK',
    'DISPID_SMSADeviceId', 'SPCT_DICTATION',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SABIMinNotification',
    'SPEVENT', 'SPSHORTCUTPAIRLIST', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRCEInterference', 'SVP_19', 'SpeechAudioState',
    'SPINTERFERENCE_TOOFAST', 'SpeechGrammarTagUnlimitedDictation',
    'SREStreamStart', 'SPSEMANTICERRORINFO',
    'DISPID_SRGetPropertyString', 'ISpPhoneticAlphabetSelection',
    'SPAS_RUN', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SLPLangId', 'SPGS_DISABLED', 'SAFT11kHz8BitMono',
    'SDKLDefaultLocation', 'DISPID_SPIAudioSizeTime',
    'DISPID_SRRAudioFormat', 'DISPID_SGRName', 'SPRECOSTATE',
    'DISPID_SpeechRecognizer', 'SpeechRegistryUserRoot',
    'SAFTADPCM_8kHzStereo', 'DISPID_SPIGetText', 'DISPID_SVEBookmark',
    'DISPID_SASetState', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SGRsCommit', 'DISPID_SDKOpenKey',
    'SAFTCCITT_ALaw_8kHzStereo', 'SAFTADPCM_44kHzMono',
    'SAFT11kHz16BitStereo', 'SpeechAudioFormatType', 'SPSHT_Unknown',
    'SPXRO_SML', 'DISPID_SRCVoicePurgeEvent', 'STCLocalServer',
    'SAFT12kHz16BitStereo', 'SpeechTokenShellFolder',
    'DISPID_SOTSetId', 'SPRST_INACTIVE_WITH_PURGE', 'SVEVoiceChange',
    'SAFT22kHz16BitStereo', 'DISPID_SRGCmdSetRuleIdState',
    'SPSFunction', 'SPEI_RESERVED1',
    'DISPID_SpeechLexiconPronunciation', 'SP_VISEME_1',
    'SSTTWildcard', 'SPEVENTSOURCEINFO', 'SpeechDiscardType',
    'SVP_17', 'SREFalseRecognition', 'SRTSMLTimeout',
    'SpeechAudioFormatGUIDWave', 'SREPropertyNumChange',
    'DISPID_SPPsItem', 'SAFT22kHz8BitStereo', 'ISpeechPhraseProperty',
    'DISPID_SpeechGrammarRuleState', 'ISpeechAudioBufferInfo',
    'DISPID_SPACommit', 'SpeechStreamFileMode', 'DISPID_SRCResume',
    'DISPID_SRCBookmark', 'DISPID_SAEventHandle',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRGRecoContext',
    'tagSPPROPERTYINFO', 'SDTReplacement', 'SAFTADPCM_11kHzMono',
    'ISpeechGrammarRuleState', 'DISPID_SRCERequestUI',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFT8kHz16BitMono',
    'SGPronounciation', 'SPBO_AHEAD', 'SPEI_SENTENCE_BOUNDARY',
    'IEnumSpObjectTokens', 'DISPID_SpeechObjectToken',
    'DISPID_SPIRule', 'eLEXTYPE_VENDORLEXICON', 'SDTRule', 'SVP_12',
    'SPBO_NONE', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SDTAlternates',
    'DISPID_SVEStreamEnd', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SpeechCustomStream', 'UINT_PTR', 'DISPID_SDKDeleteValue',
    'DISPID_SLRemovePronunciation', 'eLEXTYPE_PRIVATE13',
    'ISpSerializeState', 'SVSFIsXML', 'SECFIgnoreCase',
    'DISPID_SDKSetStringValue', 'SVSFVoiceMask',
    'DISPID_SVSLastBookmark', 'DISPID_SVEWord',
    'ISpeechPhraseReplacements', 'ISpeechXMLRecoResult',
    'IInternetSecurityMgrSite', 'SP_VISEME_11', 'SP_VISEME_5',
    'DISPID_SRCreateRecoContext', 'SDTAudio', 'DISPID_SOTDisplayUI',
    'DISPID_SRGReset', 'DISPID_SGRSTsCount', 'DISPID_SGRSTransitions',
    'ISpShortcut', 'SPCT_SUB_DICTATION', 'DISPID_SPIReplacements',
    'SpSharedRecoContext', 'SpeechSpecialTransitionType',
    'SREStateChange', 'DISPID_SRSCurrentStreamNumber',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SpeechAudioStatus',
    'SP_VISEME_10', 'DISPID_SGRsItem',
    'DISPID_SRGSetWordSequenceData', 'SSSPTRelativeToEnd',
    'DISPID_SPRDisplayAttributes', 'SRATopLevel', 'SPEI_RECOGNITION',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SPRsCount', 'DISPID_SASState',
    'SDTDisplayText', 'SRESoundStart', 'SDTProperty',
    'DISPID_SVIsUISupported', 'SRTReSent', 'SPCS_ENABLED', 'STCAll',
    'DISPID_SVVolume', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SASFreeBufferSpace', 'SPVISEMES', 'SBOPause',
    'DISPID_SpeechPhraseAlternate', 'SAFT32kHz16BitStereo',
    'SPSHORTCUTPAIR', 'ISpNotifySource', 'DISPID_SRAudioInput',
    'SRSEDone', 'SPRS_INACTIVE', 'SVPOver', 'LONG_PTR',
    'SpResourceManager', 'eLEXTYPE_PRIVATE6', 'DISPID_SMSGetData',
    'DISPID_SGRSTs_NewEnum', 'SVP_16', 'SPRULESTATE',
    'SpeechCategoryAudioOut', 'SPAO_NONE',
    'DISPID_SRRGetXMLErrorInfo', 'SPCT_SUB_COMMAND',
    'DISPID_SDKCreateKey', 'SPCATEGORYTYPE', 'DISPID_SPRuleId',
    'DISPID_SLWsItem', 'SWPKnownWordPronounceable', 'DISPID_SLPType',
    'DISPID_SPPs_NewEnum', 'SPAR_Medium', 'DISPID_SOTDataKey',
    'ISpResourceManager', 'SGSExclusive', 'SPSUnknown',
    'SPWORDPRONUNCIATION', 'ISpeechCustomStream',
    'DISPID_SVAlertBoundary', 'DISPID_SVSyncronousSpeakTimeout',
    'SpeechPropertyHighConfidenceThreshold',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SOTCDefault',
    'SDTPronunciation', 'DISPID_SBSFormat',
    'DISPID_SpeechAudioBufferInfo', 'SRESoundEnd', 'SPAR_Unknown',
    'SPVPRI_NORMAL', 'SSTTDictation', 'SPPS_Function',
    '_ISpeechVoiceEvents', 'DISPID_SpeechPhraseInfo', 'SRERequestUI',
    'SAFT32kHz8BitMono', 'DISPID_SpeechLexiconWord',
    'DISPID_SDKEnumValues', 'DISPID_SBSWrite', 'SECFDefault',
    'SPWORD', 'DISPID_SVSLastResult', 'SpTextSelectionInformation',
    'SAFT16kHz8BitStereo', 'DISPID_SRCEAudioLevel',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SVStatus',
    'SVSFIsNotXML', 'SPEI_END_INPUT_STREAM',
    'SpeechPropertyAdaptationOn', 'SpeechRecoEvents',
    'DISPID_SRGCommit', 'SPEI_SOUND_END', 'DISPID_SRStatus',
    'SPEI_TTS_AUDIO_LEVEL', 'SPINTERFERENCE_NOSIGNAL',
    'SPAUDIOSTATUS', 'STSF_AppData', 'DISPID_SPPValue', 'SP_VISEME_4',
    'ISpXMLRecoResult', 'SITooFast',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SREAudioLevel',
    'SpMMAudioEnum', 'eLEXTYPE_USER_SHORTCUT', 'SAFTDefault',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SLGetGenerationChange',
    'SpeechWordType', 'eLEXTYPE_PRIVATE5',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRCEventInterests',
    'DISPID_SMSSetData', 'SPAO_RETAIN_AUDIO', 'SP_VISEME_12',
    'SGRSTTDictation', 'SFTInput', 'SAFTCCITT_ALaw_11kHzStereo',
    'SP_VISEME_16', 'SpeechPropertyResourceUsage', 'IStream',
    'DISPIDSPTSI_ActiveLength', 'SRAInterpreter', 'SpeechMicTraining',
    'DISPID_SGRId', 'ISpeechPhraseInfo', 'SPWORDLIST', 'SpStream',
    'SVEViseme', 'DISPID_SVEStreamStart', 'SVEAllEvents',
    'SAFTNonStandardFormat', 'DISPID_SLWType', 'SP_VISEME_2',
    'DISPID_SPRules_NewEnum', 'DISPID_SPRText',
    'SpeechVoiceSpeakFlags', 'DISPID_SPRs_NewEnum',
    'DISPID_SPCIdToPhone', 'SPEI_ADAPTATION', 'SASClosed',
    'SpeechBookmarkOptions', 'SpeechRecognitionType', 'SINone',
    'ISpeechRecognizer', 'SpeechCategoryVoices',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPARecoResult', 'SVP_18',
    'SPGRAMMARSTATE', 'ISpeechPhraseRule', 'SREStreamEnd',
    'SPPS_RESERVED1', 'ISpRecoResult', 'DISPID_SRGDictationSetState',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SpeechObjectTokens',
    'DISPID_SCSBaseStream', 'ISpeechRecoGrammar',
    'DISPID_SWFEExtraData', 'DISPID_SRCCreateGrammar',
    'DISPID_SLAddPronunciationByPhoneIds', 'ISpEventSink',
    'eLEXTYPE_PRIVATE12', 'SPINTERFERENCE_TOOLOUD',
    'ISpNotifyTranslator', 'SGRSTTTextBuffer', 'SPINTERFERENCE_NOISE',
    'SRSEIsSpeaking', '__MIDL_IWinTypes_0009', 'SPSVerb',
    'IEnumString', 'SPAR_High', 'ISpPhrase', 'SpeechGrammarWordType',
    'DISPID_SLPs_NewEnum', 'SpeechLexiconType',
    'DISPID_SRCEStartStream', 'SP_VISEME_21', 'SDA_No_Trailing_Space',
    'DISPID_SPAs_NewEnum', 'DISPID_SRGetFormat',
    'DISPID_SRRPhraseInfo', 'SPLO_STATIC', 'DISPID_SLPSymbolic',
    'SGRSTTWildcard', 'SAFT44kHz8BitMono', 'ISpRecognizer',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechAllElements',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SPIAudioStreamPosition',
    'DISPIDSPTSI_SelectionOffset', 'SpeechTokenIdUserLexicon',
    'DISPID_SRSCurrentStreamPosition', 'SpeechUserTraining',
    'DISPID_SWFEFormatTag', 'SPVPRIORITY', 'DISPID_SpeechFileStream',
    'eLEXTYPE_PRIVATE3', 'SVP_14', 'DISPID_SPIEngineId',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVSFNLPMask',
    'SPPS_Unknown', 'SAFT22kHz16BitMono', 'DISPID_SOTCGetDataKey',
    'SVSFParseSsml', 'SPPS_RESERVED2', 'SPEI_MIN_TTS',
    'DISPID_SVSRunningState', 'DISPID_SLGetPronunciations',
    'SPLEXICONTYPE', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SpeechRuleState', 'ISpeechAudioFormat', 'SPEI_SR_BOOKMARK',
    'DISPID_SVSInputWordPosition', 'SSSPTRelativeToStart',
    'SPEI_MIN_SR', 'DISPID_SVSInputSentencePosition',
    'DISPID_SRProfile', 'SPRECOCONTEXTSTATUS', 'SGRSTTWord',
    'ISpeechMemoryStream', 'SRSActiveAlways', 'DISPID_SOTsItem',
    'SAFT48kHz16BitStereo', 'DISPID_SRRAudio', 'DISPID_SOTRemove',
    'DISPID_SDKGetStringValue', 'DISPID_SVEVoiceChange',
    'DISPID_SWFEAvgBytesPerSec', 'SPPARTOFSPEECH',
    'DISPID_SRGetPropertyNumber', 'SpeechCategoryPhoneConverters',
    'ISpeechResourceLoader', 'SINoise', 'SPCONTEXTSTATE', 'ISpStream',
    'SVPNormal', 'SAFTADPCM_22kHzStereo', 'STSF_FlagCreate',
    'SRAExport', 'SDKLCurrentUser', 'SpAudioFormat', 'SPWT_DISPLAY',
    'DISPID_SGRsDynamic', 'SVSFParseAutodetect',
    'DISPID_SGRsCommitAndSave', 'DISPID_SRGId', 'SAFT48kHz16BitMono',
    'DISPID_SABufferInfo', 'SpeechRunState', 'DISPID_SRCESoundEnd',
    'DISPID_SpeechPhraseAlternates', 'SPAUDIOSTATE',
    'DISPID_SOTCEnumerateTokens', 'SpeechGrammarTagWildcard',
    'SP_VISEME_17', 'DISPID_SpeechPhraseReplacements',
    'SpNullPhoneConverter', 'SVESentenceBoundary',
    'DISPID_SPPConfidence', 'SVP_3', 'DISPID_SRCEBookmark',
    'DISPID_SRCERecognition', 'ISpeechLexiconWord',
    'SAFT8kHz16BitStereo', 'SPEI_PHRASE_START', 'SAFT11kHz16BitMono',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPRST_ACTIVE', 'SpLexicon',
    'DISPID_SWFEChannels', 'SpObjectTokenCategory',
    'SpPhraseInfoBuilder', 'SpPhoneConverter',
    'SpeechPropertyResponseSpeed', 'ISpeechObjectTokenCategory',
    'SREBookmark', 'DISPID_SRGCmdLoadFromObject',
    'eLEXTYPE_PRIVATE17', 'SVP_10', 'SVP_6', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SDKSetBinaryValue',
    'SREAdaptation', 'DISPID_SRCEEnginePrivate', 'SPDATAKEYLOCATION',
    'DISPID_SWFEBitsPerSample', 'eLEXTYPE_LETTERTOSOUND',
    'ISpeechRecoResult', 'SWTAdded', 'SAFT48kHz8BitStereo',
    'DISPID_SRAudioInputStream', 'SVEEndInputStream',
    'SPEI_INTERFERENCE', 'DISPID_SDKDeleteKey',
    'DISPID_SRRRecoContext', 'SVSFPersistXML', 'SECNormalConfidence',
    'SPWORDPRONOUNCEABLE', 'SpeechTokenKeyFiles', 'SRAONone',
    'DISPID_SpeechPhraseElement', 'DISPID_SpeechLexiconProns',
    'SPVOICESTATUS', 'SGRSTTRule', 'DISPID_SRGRules',
    'SREPhraseStart', 'SPGRAMMARWORDTYPE', 'SPEI_VISEME', 'SVP_13',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpEventSource',
    'DISPID_SGRAttributes', 'eLEXTYPE_PRIVATE2',
    'SAFTGSM610_8kHzMono', 'DISPID_SpeechPhraseElements',
    'ISpeechRecoResult2', 'DISPID_SWFEBlockAlign',
    'SPEI_RECO_STATE_CHANGE', 'ISpeechMMSysAudio', 'DISPID_SVSkip',
    'SP_VISEME_3', 'SVEPrivate', 'eLEXTYPE_PRIVATE1',
    'DISPID_SPRFirstElement', 'eLEXTYPE_USER',
    'DISPID_SVEEnginePrivate', 'DISPID_SPIElements',
    'ISpRecoGrammar2', 'WAVEFORMATEX', 'SpeechRuleAttributes',
    'ISpPhoneticAlphabetConverter', 'SPAR_Low', 'SRSActive',
    'SPPS_NotOverriden', 'SRTAutopause', 'DISPID_SDKSetLongValue',
    'SVP_11', 'SPPS_RESERVED3', 'DISPID_SpeechPhraseProperty',
    'SPPHRASE', 'ISpeechLexicon', 'DISPID_SLWPronunciations',
    'SPVPRI_OVER', 'SpeechGrammarRuleStateTransitionType',
    'SITooQuiet', 'ISpeechDataKey', 'SVEAudioLevel',
    'DISPID_SVAudioOutput', 'ISequentialStream',
    'SpeechCategoryAppLexicons', 'DISPID_SVPause', 'SPVPRI_ALERT',
    'SREHypothesis', 'SPBOOKMARKOPTIONS', 'SPEI_TTS_PRIVATE',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRGCmdLoadFromResource', 'SPSERIALIZEDRESULT',
    'SPEI_RESERVED5', 'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SAVolume',
    'SPPS_RESERVED4', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'ISpeechLexiconPronunciation', 'SpNotifyTranslator',
    'DISPID_SPPParent', 'DISPID_SVDisplayUI', 'ISpRecoContext2',
    'SPRST_NUM_STATES', 'ISpeechPhraseAlternates', 'SVP_21',
    'ISpeechGrammarRules', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPWF_SRENGINE', 'SPGS_ENABLED', 'SAFTNoAssignedFormat',
    'ISpRecognizer2', 'SPPROPERTYINFO', 'SAFT44kHz8BitStereo',
    'ISpMMSysAudio', 'ISpeechPhraseReplacement',
    'ISpObjectTokenCategory', 'ISpRecoContext', 'SVP_1',
    'SpeechDisplayAttributes', 'SpeechVoiceCategoryTTSRate',
    'SRERecognition', 'DISPID_SPIGrammarId', 'DISPID_SPPChildren',
    'SPFILEMODE', 'DISPID_SPRuleParent', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechVoiceEvent', 'ISpObjectToken',
    'DISPID_SVSLastBookmarkId', 'STSF_LocalAppData',
    'DISPID_SVGetProfiles', 'SpeechInterference',
    'DISPID_SRCEPropertyStringChange', 'eLEXTYPE_MORPHOLOGY',
    'SAFTCCITT_uLaw_44kHzMono', 'SAFT24kHz8BitStereo',
    'DISPID_SADefaultFormat', 'SPDKL_LocalMachine', 'DISPID_SRGState',
    'DISPID_SOTMatchesAttributes', 'SpeechVoiceSkipTypeSentence',
    'SP_VISEME_15', 'SPINTERFERENCE_NONE', 'DISPID_SRGDictationLoad',
    'SAFT12kHz8BitStereo', 'DISPID_SRSClsidEngine',
    'DISPID_SpeechBaseStream', 'ISpeechRecognizerStatus',
    'DISPID_SPRNumberOfElements', 'DISPID_SPRuleEngineConfidence',
    'SPRST_ACTIVE_ALWAYS', 'ISpeechVoiceStatus', 'DISPID_SGRsCount',
    'SpeechEngineConfidence', 'IInternetSecurityManager',
    'SRCS_Enabled', 'SPEI_MAX_TTS', 'SPEI_MAX_SR',
    'SpeechCategoryRecoProfiles', 'SAFTCCITT_ALaw_44kHzMono',
    'eLEXTYPE_PRIVATE16', 'SPSNoun',
    'DISPID_SOTRemoveStorageFileName', 'SPPS_Modifier',
    'DISPID_SpeechRecoResult2', 'SPDKL_CurrentUser',
    'DISPID_SpeechRecoContext', 'DISPID_SRRSaveToMemory',
    'DISPID_SVEventInterests', 'eWORDTYPE_DELETED',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPEI_VOICE_CHANGE',
    'DISPID_SPPsCount', 'ISpeechObjectToken',
    'DISPID_SVSpeakCompleteEvent', 'SPAS_PAUSE',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRCPause',
    'DISPID_SGRSTText', 'ISpeechBaseStream',
    'DISPID_SASNonBlockingIO', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SpeechObjectTokenCategory', 'eLEXTYPE_PRIVATE11',
    'DISPID_SPPFirstElement', 'SpeechDataKeyLocation',
    'SGLexicalNoSpecialChars', 'SpeechRetainedAudioOptions',
    'DISPID_SPEsItem', 'SBONone', 'DISPID_SGRSTsItem',
    'SRERecoOtherContext', 'DISPID_SMSAMMHandle',
    'DISPID_SVSVisemeId', 'DISPID_SOTCreateInstance',
    'DISPID_SpeechRecoContextEvents', 'SAFT8kHz8BitMono',
    'SDTLexicalForm', 'DISPID_SLWs_NewEnum', 'DISPID_SPILanguageId',
    'SAFT16kHz16BitMono', '_ISpeechRecoContextEvents',
    'DISPID_SRGSetTextSelection', 'STSF_CommonAppData', 'SLTApp',
    'SVSFUnusedFlags', 'SRSInactiveWithPurge',
    'DISPID_SVESentenceBoundary', 'SGSEnabled', 'DISPID_SGRsFindRule',
    'DISPID_SPEDisplayText', 'SVPAlert', 'SGLexical', 'SVP_9',
    'SP_VISEME_6', 'SPEI_FALSE_RECOGNITION', 'SPDKL_CurrentConfig',
    'SPSTREAMFORMATTYPE', '_SPAUDIOSTATE', 'ISpeechPhoneConverter',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRRecognizer',
    'SDA_Two_Trailing_Spaces', 'SAFT12kHz16BitMono',
    'SSFMOpenReadWrite', 'SAFTExtendedAudioFormat',
    'SAFTCCITT_ALaw_44kHzStereo', 'SpSharedRecognizer',
    'eLEXTYPE_PRIVATE18', 'SVEWordBoundary',
    'DISPID_SGRSAddRuleTransition', 'SLOStatic',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRSetPropertyNumber', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SOTCId', 'SPFM_OPEN_READONLY',
    'DISPID_SPPEngineConfidence', 'STCInprocHandler',
    'DISPID_SGRClear', 'SPEI_UNDEFINED', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRCState', 'SRSInactive', 'DISPID_SGRInitialState',
    'eLEXTYPE_RESERVED8', 'SRTEmulated', 'DISPID_SOTIsUISupported',
    'SPPS_Noncontent', 'ISpeechAudio', 'SAFT32kHz8BitStereo',
    'ISpDataKey', 'SVP_15', 'DISPID_SRCCreateResultFromMemory',
    'SRAImport', 'SPXRO_Alternates_SML', 'DISPID_SPEActualConfidence',
    'DISPID_SVPriority', 'DISPID_SRRTimes', 'SpMMAudioIn',
    'SSTTTextBuffer', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SFSClose', 'ISpNotifySink', 'SPBO_TIME_UNITS',
    'DISPID_SLAddPronunciation', 'SDKLLocalMachine',
    'DISPID_SRCEHypothesis', 'SPXMLRESULTOPTIONS',
    'DISPID_SOTGetAttribute', 'SPEI_HYPOTHESIS', 'SPAS_CLOSED',
    'DISPID_SpeechPhraseRule', 'DISPID_SPAsCount',
    'SpeechStreamSeekPositionType', 'DISPID_SVGetAudioOutputs',
    'DISPID_SVGetVoices', 'SPFM_CREATE_ALWAYS',
    'DISPID_SpeechRecoResult', 'SpInProcRecoContext',
    'Speech_Max_Pron_Length', 'SpeechRecoProfileProperties',
    'SAFTGSM610_44kHzMono', 'SDKLCurrentConfig',
    'SAFTGSM610_11kHzMono', 'SPSMF_UPS', 'SPPS_SuppressWord',
    'SASRun', 'DISPID_SABIEventBias', 'SpStreamFormatConverter',
    'DISPID_SPANumberOfElementsInResult', 'SVSFIsFilename',
    'SpeechFormatType', 'SVF_None', 'DISPID_SRGCmdLoadFromMemory',
    'ISpVoice', 'SAFTCCITT_uLaw_44kHzStereo', 'SPSHT_EMAIL',
    'SPEI_SOUND_START', 'SPLOADOPTIONS', 'SpeechGrammarTagDictation',
    'SpMemoryStream', 'DISPID_SpeechVoice', 'DISPID_SOTsCount',
    'SPADAPTATIONRELEVANCE', 'DISPID_SRSNumberOfActiveRules',
    'SpeechRegistryLocalMachineRoot', 'SpMMAudioOut',
    'DISPID_SpeechWaveFormatEx', 'eLEXTYPE_RESERVED4',
    'SpObjectToken', 'STCRemoteServer', 'DISPID_SPRulesCount',
    'ISpeechAudioStatus', 'ISpeechTextSelectionInformation',
    'eLEXTYPE_PRIVATE8', 'tagSPTEXTSELECTIONINFO', 'SPGS_EXCLUSIVE',
    'SPPHRASEELEMENT', 'DISPID_SPCLangId', 'SPWAVEFORMATTYPE',
    'eLEXTYPE_RESERVED7', 'SpeechRecoContextState',
    'SSFMCreateForWrite', 'DISPID_SVSpeakStream', 'DISPID_SPPName',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SLGetWords', 'SVP_5', 'DISPID_SFSOpen', 'DISPID_SPPId',
    'SPSHT_NotOverriden', 'DISPID_SASCurrentSeekPosition',
    'SpeechVisemeType', 'DISPID_SVSPhonemeId', 'DISPID_SVEAudioLevel',
    'DISPID_SAStatus', 'DISPID_SGRSTType', 'SPRECORESULTTIMES',
    'SAFT12kHz8BitMono', 'SPEI_WORD_BOUNDARY', 'SRTStandard',
    'eLEXTYPE_RESERVED9', 'SRARoot', 'SpInprocRecognizer',
    'DISPID_SPERetainedSizeBytes', 'SPTEXTSELECTIONINFO',
    'DISPID_SRRSpeakAudio', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SLGenerationId', 'DISPID_SpeechLexicon',
    'ISpObjectWithToken', 'SpeechRecognizerState',
    'DISPID_SABufferNotifySize', 'SP_VISEME_19', 'SP_VISEME_7',
    'DISPID_SpeechVoiceStatus', 'DISPID_SLWLangId',
    'DISPID_SVGetAudioInputs', 'SAFT8kHz8BitStereo',
    'SGDSActiveWithAutoPause', 'SAFT16kHz8BitMono',
    'SPPHRASEREPLACEMENT', 'SAFT24kHz16BitStereo',
    'DISPID_SpeechMemoryStream', 'SPPHRASEPROPERTY',
    'SPSEMANTICFORMAT', 'SpeechGrammarState', 'SPBO_PAUSE',
    'SVSFParseMask', 'DISPID_SPEsCount', 'SVP_8',
    'SpeechEngineProperties', 'SAFT44kHz16BitStereo',
    'DISPID_SGRSAddWordTransition', 'eLEXTYPE_PRIVATE20',
    'ISpLexicon', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SpeechAudio', 'SREInterference', 'SPFM_OPEN_READWRITE',
    'SP_VISEME_20', 'SVF_Emphasis', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPEEngineConfidence', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRState', 'SP_VISEME_13', 'DISPID_SRGetRecognizers',
    'DISPID_SDKGetlongValue', 'DISPID_SWFESamplesPerSec',
    'DISPID_SpeechLexiconWords', 'ISpeechWaveFormatEx',
    'SPSInterjection', 'DISPID_SpeechGrammarRule'
]
